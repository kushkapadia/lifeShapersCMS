...
<header class="site-header">
    <span><a href="/"><p class="logo"><i class="fab fa-envira"></i><b>L</b>ife<b>S</b>hapers</p></a></span>
    <nav class="site-menu">
        <ul>
          <li><a href="/"><i class="fas fa-home"></i> Home</a></li>
          <li><a href="https://drive.google.com/drive/folders/1exPM6LhFQHWkFMwdDN7GUrDWFpxa5_2T?usp=sharing" target="_blank"><i class="fas fa-cloud-upload-alt"></i> Upload</a></li>
          
          <li><a href="/reports"><i class="fas fa-file-pdf"></i> FS Report</a></li>
          <li><a href="https://lifeshapers.in" target="_blank"><i class="fas fa-globe"></i> Website</a></li>
          <li class="navbar-btn"><a href="/all-clients"><button class="cli-btn">All Clients</button></a></li>
...
<head>
    ...
    <title>Life Shapers | Build Solid Success</title>
    ...
    <!-- Life Shapers Design System Css -->
...
<body class="  ">
    ...
    <aside class="sidebar sidebar-default navs-rounded-all " width="100">
        <div class="sidebar-header d-flex align-items-center justify-content-start">
          <a href="/" class="navbar-brand">
            ...
            <!-- <img src="lifeshapers.png" width="32" height="32" alt=""> -->
                <h4 class="logo-title">Life Shapers</h4> 
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                        ...
                        <ul class="sub-nav collapse" id="horizontal-menu" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="/add-user-page">
                                    ...
                                    <span class="item-name"> Add New Enquiry </span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="/view-prospect-list">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <g>
                                    ...
                                    <span class="item-name">Prospect List</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="/view-client-list">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <g>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-user" role="button"
                            ...
                            <span class="item-name">Schedules</span>
                            <i class="right-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="/allAppointmentStatus">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <g>
                                    ...
                                    <span class="item-name">Appointments Status</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="/upcomingAppointments">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <g>
                                    ...
                                    <i class="sidenav-mini-icon"> S </i>
                                    <span class="item-name">Upcoming Appointments</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="/tentativeAppointments">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <g>
                                    ...
                                    <i class="sidenav-mini-icon"> S </i>
                                    <span class="item-name">Tentative Appointments</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="/confirmedAppointments">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <g>
                                    ...
                                    <i class="sidenav-mini-icon"> S </i>
                                    <span class="item-name">Confirmed Appointments</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="/add-session-request-form">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <g>
                                    ...
                                    <i class="sidenav-mini-icon"> S </i>
                                    <span class="item-name">Add Session Request</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="/session-request-list">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <g>
                                    ...
                                    <i class="sidenav-mini-icon"> S </i>
                                    <span class="item-name">Session Request List</span>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-auth" role="button"
                            ...
                            <span class="item-name">Sessions & Packages</span>
                            <i class="right-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <ul class="sub-nav collapse" id="sidebar-auth" data-bs-parent="#sidebar-menu">
                            ...
                            <!-- <li class="nav-item">
                                <a class="nav-link" href="/add-session">
                                    ...
                                    <span class="item-name">Record a Session</span>
                                </a>
                            </li> -->
                            <!-- <li class="nav-item">
                                <a class="nav-link" href="../dashboard/auth/confirm-mail.html">
                                    ...
                                    <i class="sidenav-mini-icon"> S </i>
                                    <span class="item-name">Session List</span>
                                </a>
                            </li> -->
                            <li class="nav-item">
                                <a class="nav-link" href="/record-new-package">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <g>
                                    ...
                                    <i class="sidenav-mini-icon"> R </i>
                                    <span class="item-name">Record A Package</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/getAllPackages">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <g>
                                    ...
                                    <i class="sidenav-mini-icon"> A </i>
                                    <span class="item-name">Package List</span>
                                </a>
                            </li>
                            <!-- <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#utilities-error" role="button" aria-expanded="false"
                            ...
                            <span class="item-name">Team Management</span>
                            <i class="right-icon">
                        ...
                        <ul class="sub-nav collapse" id="utilities-error" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="/displayManagerList">
                                    <i class="icon">
                                    ...
                                    <span class="item-name">View Team Member List</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="/displayAddManager">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <span class="item-name">Add Team Member</span>
                                </a>
                            </li>
                               @else
                               @endauth
                            <li class="nav-item">
                                <a class="nav-link " href="/displayRecordAttendance/">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <span class="item-name">Record Attendance</span>
                                </a>
                            </li>
                            <!-- <li class="nav-item">
                                <a class="nav-link " href="/displayRecordAttendance/">
                                    ...
                                    <span class="item-name">Salary Computation</span>
                                </a>
                            </li> -->
                            <li class="nav-item">
                                <a class="nav-link" href="/displayStaffAttendance">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <span class="item-name">Display Attendance</span>
                                </a>
                            </li>
                    ...
                    <!-- <li class="nav-item">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-special" role="button"
                            ...
                            <span class="item-name">M.I.S Reports</span>
                            <i class="right-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <ul class="sub-nav collapse" id="sidebar-special" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="/finance-report">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <g>
                    ...
                    <!-- <li class="nav-item">
                        <a class="nav-link" href="/printable-templates">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M7.7688 8.71387H16.2312C18.5886 8.71387 20.5 10.5831 20.5 12.8885V17.8254C20.5 20.1308 18.5886 22 16.2312 22H7.7688C5.41136 22 3.5 20.1308 3.5 17.8254V12.8885C3.5 10.5831 5.41136 8.71387 7.7688 8.71387ZM11.9949 17.3295C12.4928 17.3295 12.8891 16.9419 12.8891 16.455V14.2489C12.8891 13.772 12.4928 13.3844 11.9949 13.3844C11.5072 13.3844 11.1109 13.772 11.1109 14.2489V16.455C11.1109 16.9419 11.5072 17.3295 11.9949 17.3295Z"
                            ...
                            <span class="item-name">Print Templates</span>
                        </a>
                    </li> -->
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="sub-nav collapse" id="sidebar-widget" data-bs-parent="#sidebar-menu">
                                    <li class="nav-item">
                                        <a class="nav-link " href="/displayAddEventPage">
                                            <i class="icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                                    fill="currentColor">
                                                    <g>
                                            ...
                                            <i class="sidenav-mini-icon"> A </i>
                                            <span class="item-name">Add Events</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
          ...
          <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
            <div class="container-fluid navbar-inner">
              <a href="..//" class="navbar-brand">
                  ...
                  <!--logo End-->        <h4 class="logo-title">Life Shapers</h4>
              </a>
              <div class="sidebar-toggle" data-toggle="sidebar" data-active="true">
                  <i class="icon">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                   <!-- <li class="nav-item dropdown">
                      ...
                      <img src="/images/Flag/flag001.png" class="img-fluid rounded-circle" alt="user" style="height: 30px; min-width: 30px; width: 30px;">
                          ...
                          <div class="m-0 border-0 shadow-none card">
                              <div class="p-0 ">
                                  <ul class="p-0 list-group list-group-flush">
                                      <li class="iq-sub-card list-group-item"><a class="p-0" href="#"><img src="/images/Flag/flag-03.png" alt="img-flaf" class="img-fluid me-2" style="width: 15px;height: 15px;min-width: 15px;"/>Spanish</a></li>
                                      <li class="iq-sub-card list-group-item"><a class="p-0" href="#"><img src="/images/Flag/flag-04.png" alt="img-flaf" class="img-fluid me-2" style="width: 15px;height: 15px;min-width: 15px;"/>Italian</a></li>
                                      <li class="iq-sub-card list-group-item"><a class="p-0" href="#"><img src="/images/Flag/flag-02.png" alt="img-flaf" class="img-fluid me-2" style="width: 15px;height: 15px;min-width: 15px;"/>French</a></li>
                                      <li class="iq-sub-card list-group-item"><a class="p-0" href="#"><img src="/images/Flag/flag-05.png" alt="img-flaf" class="img-fluid me-2" style="width: 15px;height: 15px;min-width: 15px;"/>German</a></li>
                                      <li class="iq-sub-card list-group-item"><a class="p-0" href="#"><img src="/images/Flag/flag-06.png" alt="img-flaf" class="img-fluid me-2" style="width: 15px;height: 15px;min-width: 15px;"/>Japanese</a></li>
                                  </ul>
                              </div>
                          </div>
                      </div>
                  ...
                  <li class="nav-item dropdown">
                    <a href="/admin/settings"  class="nav-link" id="notification-drop">
                  ...
                  <li class="nav-item dropdown">
                    <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                      ...
                      <div class="caption ms-3 d-none d-md-block ">
                          <h6 class="mb-0 caption-title">Kush Kapadia</h6>
