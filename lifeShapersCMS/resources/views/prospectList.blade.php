@include('includes.header')
  ...
  <div class="conatiner-fluid content-inner mt-n5 py-4">
    <div>
      <div class="row">
        <div class="col-sm-12">
          <div class="card">
            ...
            <div class="card-body p-2">
              <div class="table-responsive">
                <table id="user-list-table" class="table table-center table-striped" role="grid" data-toggle="data-table">
                  <thead>
                    <tr class="ligth">
                      <th>Profile</th>
                      <th>Name</th>
                    ...
                    @foreach ($prospects as $prospect)
                        ...
                        <tr>
                          <td class="text-center"><img class="bg-soft-primary rounded img-fluid avatar-40 me-3"
                              src="/assets/images/avatars/01.png" alt="profile"></td>
                          <td>
                            {{ $prospect['f_name'] }} {{ $prospect['l_name'] }}
                          </td>
                          <td>
                            {{ $prospect['mobile'] }}
                          </td>
                          ...
                          <td>
                            {{-- {{ $prospect->addDate->format('d/m/Y') }} --}}
                          </td>
                          <td>
                            <div class="flex align-items-center list-user-action">
                              <a class="btn btn-sm btn-icon btn-success" data-toggle="tooltip" data-placement="top"
                                title="" data-original-title="Add"href="{{ url('/viewProfile/' . $prospect['id']) }}">
                                View Cabinet
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="d-grid gap-x-3 grid-cols-2 mb-4">
            ...
            <div class="text-center">
              <img src="/assets/images/settings/dark/02.png" alt="" class="mode dark-img img-fluid btn-border p-0 flex-column"
                data-setting="dir-mode" data-name="dir" data-value="rtl">
              <img src="/assets/images/settings/light/02.png" alt=""
                class="mode light-img img-fluid btn-border p-0 flex-column" data-setting="dir-mode" data-name="dir"
                data-value="rtl">
