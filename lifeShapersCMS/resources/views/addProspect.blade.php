...
@include('includes.header')
            ...
            <div class="col-md-12">
               <div class="flex-wrap d-flex justify-content-between align-items-center">
                  <div>
                     ...
                     <p>
                        Welcome to Contact Cabinet. Here, you can add new enquiries, view prospect list [new enquiries are auto-parked here; they are yet to be converted] and you can also view client list [new enquiries which have been successfully converted to our clients]. Currently, you are in 'Add New Enquiry'; so do the needful and enjoy! 
                     </p>
                  </div>
   ...
   <div class="conatiner-fluid content-inner mt-2 mt-n5 py-0">
      <div>
         <div class="row">
               ...
               <div class="card mt-2">
                  <div class="card-header d-flex justify-content-between">
                     <div class="header-title">
                        <h4 class="card-title">New Enquiry Information</h4>
                     </div>
                  </div>
                  <div class="card-body rounded">
                     <div class="new-Prospect-info">
                  ...
                  @endif
                        ...
                        <form action="/add-new-prospect" method="POST" id="prospect">
                          @csrf
                   <div class="row">
                              ...
                              <div class="row">
                                 ...
                                 <div class="form-group col-md-6">
                                    ...
                                    <input name="age" type="number" min="0" max="100" class="form-control" id="age"
                                       placeholder="Age">
                                 </div>
                                 <div class="form-group col-md-6">
                                    <label class="form-label" for="cname">Company Name:</label>
                                    <input type="text" name="company" class="form-control" id="cname" placeholder="Company Name">
                                 </div>
                              </div>
                              <div class="form-group col-md-12">
                                 <label class="form-label" for="add1">Address:</label>
                                 <textarea name="address" type="text" class="form-control" id="add1"
                                    placeholder="Street Address 1"> </textarea>
                              </div>
                              <div class="row">
                                             <div class="form-group col-md-6">
                                                <label class="form-label">Relationship Status:</label>
                                                <select name="relationshipStatus" class="form-select mb-3 shadow-none">
                                             ...
                                             <div class="form-group col-md-6">
                                                ...
                                                <select name="modeOfContact" class="form-select mb-3 shadow-none">
                                                   <option selected value="">Select</option>
                           ...
                           <div class="row">
                              <div class="form-group col-md-6">
                                 ...
                                 <select name="participants" class="form-select mb-3 shadow-none">
                                    <option selected value="">Select</option>
                              ...
                              <div class="form-group col-md-6">
                                 ...
                                 <select name="noOfParticipants" class="form-select mb-3 shadow-none" >
                                    <option selected value="">Select</option>
                              ...
                              <!-- <div class="form-group col-md-6">
                                 <label class="form-label">No of Participants:</label>
                                 <input type="number" min="0" value="1" class="form-control" id="cname" placeholder="No of Participants">
                              </div> -->
                           </div>
...
<div class="form-group col-md-12">
                              ...
                              <div class="form-check form-switch form-check-inline">
                                 <input class="form-check-input" type="checkbox" name="purpose" value="Career" id="switch2" />
                                 <label class="form-check-label pl-2" for="switch2">Career</label>
                              </div>
                              <div class="form-check form-switch form-check-inline">
                                 <input class="form-check-input" type="checkbox" name="purpose" value="Business" id="switch2" />
                                 <label class="form-check-label pl-2" for="switch2">Business</label>
                              </div>
                              <div class="form-check form-switch form-check-inline">
                                 <input class="form-check-input" type="checkbox" id="switch2" name="purpose" value="Leadership" />
                                 <label class="form-check-label pl-2" for="switch2">Leadership</label>
                              </div>
                              <div class="form-check form-switch form-check-inline">
                                 <input class="form-check-input" type="checkbox" id="switch2" name="purpose" value="Relationship" />
                                 <label class="form-check-label pl-2" for="switch2">Relationship</label>
                              </div>
                              <div class="form-check form-switch form-check-inline">
                                 <input class="form-check-input" type="checkbox" id="switch2" name="purpose" value="Life" />
                                 <label class="form-check-label pl-2" for="switch2">Life-Enrichment</label>
                              </div>
</div>
                              ...
                              <div class="form-group col-md-6">
                                 ...
                                 <input name="mobile" type="text" class="form-control" id="mobno"
                              ...
                              <div class="row mb-5">
                                    <div class="form-group col-md-6">
                                       ...
                                       <input name="source" type="text" class="form-control" id="source" placeholder="Source">
                                    </div>
                                 <div class="form-group col-md-6">
                                    <label class="form-label" for="dateOfFirstContact">Date of first Contact:</label>
                                    <input name="dateOfFirstContact" type="date" class="form-control" id="email" >
                                 </div>
                              </div>
                              <hr>
                              <h3 class="mt-5">Enquiry-Prospect-Client Conversion Activity Status</h3>
                              <h5 class="my-4 text-warning">Activity - 1</h5>
                              <div class="row">
                                 <div class="form-group col-md-6">
                                    <label for="exampleFormControlTextarea1" class="form-label">
                                       Current Activity Time Stamp:
                                    </label>
                                    <input name="currentActivityTiming" type="datetime-local" class="form-control">
                                 </div>
                                 <div class="form-group col-md-6">
                                    <label for="exampleFormControlTextarea1" class="form-label">
                                       Conversational Outcome:
                                    </label>
                                    <textarea name="conversationOutcome" placeholder="Type what was discussed?" class="form-control" id="exampleFormControlTextarea1" rows="1"></textarea>
                                 </div>
                              </div>
                              <!-- <div class="row">
                                 <div class="form-group col-md-6">
                                    <label class="form-label">No of Participants:</label>
                                    <select name="participants" class="form-select mb-3 shadow-none" required>
                              ...
                              <div class="row">
                                 <div class="form-group col-md-6">
                                    ...
                                    <select name="activityStatus" id="status1" class="form-select mb-3 shadow-none">
                                       <option selected value="">Select</option>
                                       <option value="thinkntell">Will Think and Tell</option>
                                       <option value="InProgressAgreed">In Progress - Agreed For COMP. 30</option>
                                       <option value="InProgressOver">In Progress - COMP. 30 Over; Awaiting Reply</option>
                                       <option value="Converted">Converted</option>
                                       <option value="Rejected">Rejected</option>
                                    </select>
                                 </div>
                                 <div class="form-group col-md-6 dynamic">
                              ...
                              <div class="form-group col-md-6">
                                 ...
                                 <input name="nextActivityTiming" type="datetime-local" class="form-control">
                              </div>
                              <button type="submit" name="submit" class="btn btn-primary mt-3">Add New Enquiry
                             </button>
                        </form>
                     </div>
                  </div>
