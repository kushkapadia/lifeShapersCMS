                                ...
                                <div class="card-body">
                                    <div class="progress-widget">
                                        <div id="circle-progress-01"
                                            ...
                                            {{-- //count client --}}
                                            data-min-value="0" data-max-value="100" data-value="10" data-type="percent">
                                ...
                                <div class="card-body">
                                    <div class="progress-widget">
                                        <div id="circle-progress-04"
                                            ...
                                            data-min-value="0" data-max-value="100" data-value="<%=counts.eventCount * 10 %>" data-type="percent">
                                            <svg class="card-slie-arrow " width="24" viewBox="0 0 24 24">
                                                <path fill="currentColor"
                                                    d="M19,6.41L17.59,5L7,15.59V9H5V19H15V17H8.41L19,6.41Z" />
                                            </svg>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body px-4">
                            <div class="table-responsive">
                                <table id="user-list-table" class="table text-center table-striped" role="grid"
                                        ...
                                        <% if(appointments.length !== 0) { %>
                                            <% appointments.forEach(appointment => { %>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="tel:<%= appointment.mobile %>" target="_blank">
                                                            <%= appointment.mobile %>
                                                        </a>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <%= moment(appointment.endDate).format("LLL") %>
                                                    </td>
                                                    <!-- <td>
                                                        <form action="/deleteAppointment/<%= appointment._id %>" method="POST">
