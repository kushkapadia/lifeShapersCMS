        ...
        <div class="col-md-12">
          <div class="flex-wrap d-flex justify-content-between align-items-center">
            <div>
              ...
              <p>
                 Welcome to Contact Cabinet. Here, you can add new enquiries, view prospect list [new enquiries are auto-parked here; they are yet to be converted] and you can also view client list [new enquiries which have been successfully converted to our clients]. Currently, you are in 'View Client List'; Enjoy! 
              </p>
           </div>
            <div>
                      ...
                      <% if(client.status=="client" ){ %>
                        <tr>
                          <td class="text-center"><img class="bg-soft-primary rounded img-fluid avatar-40 me-3"
                              src="/images/avatars/01.png" alt="profile"></td>
                          <td>
                          ...
                          <td>
                            <%= client.addDate.getDate() %>/<%= client.addDate.getMonth()+1 %>/
                                <%=client.addDate.getFullYear()%>
                          </td>
                          <td>
                            <div class="flex align-items-center list-user-action">
                              <a class="btn btn-sm btn-icon btn-success" data-toggle="tooltip" data-placement="top"
                                title="" data-original-title="Add" href="/viewProfile/<%=client._id%>">
                                View
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="d-grid gap-x-3 grid-cols-2 mb-4">
            ...
            <div class="text-center">
              <img src="/images/settings/dark/02.png" alt="" class="mode dark-img img-fluid btn-border p-0 flex-column"
